// -----------------------------------------------------------------------
// <copyright file="ActivityPhonecallsController.cs" company="Nodine Legal, LLC">
...
namespace OpenLawOffice.Web.Controllers
{
    ...
    public class ActivityPhonecallsController : BaseController
    {
        ...
        [HttpPost]
        [Authorize(Roles = "Login, User")]
        public ActionResult Create(ViewModels.Activities.ActivityPhonecallViewModel viewModel)
        {
            Common.Models.Account.Users currentUser;
            ...
            using (Data.Transaction trans = Data.Transaction.Create(true))
            {
                try
                {
                    ...
                    model = Data.Activities.ActivityPhonecall.Create(trans, model, currentUser);
