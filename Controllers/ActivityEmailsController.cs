// -----------------------------------------------------------------------
// <copyright file="ActivityEmailsController.cs" company="Nodine Legal, LLC">
...
namespace OpenLawOffice.Web.Controllers
{
    ...
    public class ActivityEmailsController : BaseController
    {
        [Authorize(Roles = "Login, User")]
        public ActionResult Details(long id)
        {
            ViewModels.Activities.ActivityEmailViewModel viewModel = new ViewModels.Activities.ActivityEmailViewModel();

            using (IDbConnection conn = Data.Database.Instance.GetConnection())
            {
                Common.Models.Activities.ActivityEmail model = Data.Activities.ActivityEmail.Get(id, conn, false);
                ...
                viewModel = Mapper.Map<ViewModels.Activities.ActivityEmailViewModel>(model);
        ...
        public ActionResult Create(long? regleadid, long? regopportunityid)
        {
            ...
            using (IDbConnection conn = Data.Database.Instance.GetConnection())
            {
                ...
                viewModel.Type = Mapper.Map<ViewModels.Activities.ActivityTypeViewModel>(Data.Activities.ActivityType.Get("Email", conn, false));
            }
        ...
        [HttpPost]
        [Authorize(Roles = "Login, User")]
        public ActionResult Create(ViewModels.Activities.ActivityEmailViewModel viewModel)
        {
            Common.Models.Account.Users currentUser;
            Common.Models.Activities.ActivityEmail model;
            ...
            using (Data.Transaction trans = Data.Transaction.Create(true))
            {
                try
                {
                    ...
                    model = Mapper.Map<Common.Models.Activities.ActivityEmail>(viewModel);
                    model.Type = Data.Activities.ActivityType.Get(trans, "Email");

                    if (!model.IsCampaignResponse.HasValue)
                        model.IsCampaignResponse = false;                    

                    model = Data.Activities.ActivityEmail.Create(trans, model, currentUser);
        ...
        [HttpPost]
        [Authorize(Roles = "Login, User")]
        public ActionResult Edit(long id, ViewModels.Activities.ActivityEmailViewModel viewModel)
        {
            Common.Models.Account.Users currentUser;
            Common.Models.Activities.ActivityEmail model;
            ...
            using (Data.Transaction trans = Data.Transaction.Create(true))
            {
                try
                {
                    ...
                    model = Data.Activities.ActivityEmail.Edit(trans, model, currentUser);
                    trans.Commit();
