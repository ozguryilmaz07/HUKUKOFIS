// -----------------------------------------------------------------------
// <copyright file="LeadSourceTypeViewModel.cs" company="Nodine Legal, LLC">
...
namespace OpenLawOffice.Web.ViewModels.Leads
{
    ...
    [MapMe]
    public class LeadSourceTypeViewModel : CoreViewModel
    {
        ...
        {
            Mapper.CreateMap<Common.Models.Leads.LeadSourceType, LeadSourceTypeViewModel>()
            ...
            Mapper.CreateMap<LeadSourceTypeViewModel, Common.Models.Leads.LeadSourceType>()
                .ForMember(dst => dst.Created, opt => opt.MapFrom(src => src.Created))
                .ForMember(dst => dst.Modified, opt => opt.MapFrom(src => src.Modified))
                .ForMember(dst => dst.Disabled, opt => opt.MapFrom(src => src.Disabled))
