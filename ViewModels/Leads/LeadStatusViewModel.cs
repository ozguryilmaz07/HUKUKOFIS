// -----------------------------------------------------------------------
// <copyright file="LeadStatusViewModel.cs" company="Nodine Legal, LLC">
...
namespace OpenLawOffice.Web.ViewModels.Leads
{
    ...
    [MapMe]
    public class LeadStatusViewModel : CoreViewModel
    {
        ...
        {
            Mapper.CreateMap<Common.Models.Leads.LeadStatus, LeadStatusViewModel>()
            ...
            Mapper.CreateMap<LeadStatusViewModel, Common.Models.Leads.LeadStatus>()
                .ForMember(dst => dst.Created, opt => opt.MapFrom(src => src.Created))
                .ForMember(dst => dst.Modified, opt => opt.MapFrom(src => src.Modified))
                .ForMember(dst => dst.Disabled, opt => opt.MapFrom(src => src.Disabled))
