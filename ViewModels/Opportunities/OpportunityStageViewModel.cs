...
namespace OpenLawOffice.Web.ViewModels.Opportunities
{
    ...
    [MapMe]
    public class OpportunityStageViewModel : CoreViewModel
    {
        ...
        {
            Mapper.CreateMap<Common.Models.Opportunities.OpportunityStage, OpportunityStageViewModel>()
            ...
            Mapper.CreateMap<OpportunityStageViewModel, Common.Models.Opportunities.OpportunityStage>()
                .ForMember(dst => dst.Created, opt => opt.MapFrom(src => src.Created))
                .ForMember(dst => dst.Modified, opt => opt.MapFrom(src => src.Modified))
                .ForMember(dst => dst.Disabled, opt => opt.MapFrom(src => src.Disabled))
