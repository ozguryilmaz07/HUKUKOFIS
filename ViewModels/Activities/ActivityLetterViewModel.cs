// -----------------------------------------------------------------------
// <copyright file="ActivityLetterViewModel.cs" company="Nodine Legal, LLC">
...
namespace OpenLawOffice.Web.ViewModels.Activities
{
    ...
    [MapMe]
    public class ActivityLetterViewModel : ActivityCorrespondenceBaseViewModel
    {
        public string Address { get; set; }

        public void BuildMappings()
        {
            Mapper.CreateMap<Common.Models.Activities.ActivityLetter, ActivityLetterViewModel>()
            ...
            Mapper.CreateMap<ActivityLetterViewModel, Common.Models.Activities.ActivityLetter>()
                .ForMember(dst => dst.Created, opt => opt.MapFrom(src => src.Created))
                .ForMember(dst => dst.Modified, opt => opt.MapFrom(src => src.Modified))
                .ForMember(dst => dst.Disabled, opt => opt.MapFrom(src => src.Disabled))
