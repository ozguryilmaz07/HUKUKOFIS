// -----------------------------------------------------------------------
// <copyright file="ActivityRegardingOpportunityViewModel.cs" company="Nodine Legal, LLC">
...
namespace OpenLawOffice.Web.ViewModels.Activities
{
    ...
    [MapMe]
    public class ActivityRegardingOpportunityViewModel : ActivityRegardingBaseViewModel
    {
        ...
        public void BuildMappings()
        {
            Mapper.CreateMap<Common.Models.Activities.ActivityRegardingOpportunity, ActivityRegardingOpportunityViewModel>()
                ...
                {
                    if (db.Opportunity == null || !db.Opportunity.Id.HasValue) return null;
