// -----------------------------------------------------------------------
// <copyright file="ActivityPhonecallViewModel.cs" company="Nodine Legal, LLC">
...
namespace OpenLawOffice.Web.ViewModels.Activities
{
    ...
    [MapMe]
    public class ActivityPhonecallViewModel : ActivityCorrespondenceBaseViewModel
    {
        public string PhoneNumber { get; set; }

        public void BuildMappings()
        {
            Mapper.CreateMap<Common.Models.Activities.ActivityPhonecall, ActivityPhonecallViewModel>()
            ...
            Mapper.CreateMap<ActivityPhonecallViewModel, Common.Models.Activities.ActivityPhonecall>()
                .ForMember(dst => dst.Created, opt => opt.MapFrom(src => src.Created))
                .ForMember(dst => dst.Modified, opt => opt.MapFrom(src => src.Modified))
                .ForMember(dst => dst.Disabled, opt => opt.MapFrom(src => src.Disabled))
