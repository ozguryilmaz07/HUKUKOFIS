// -----------------------------------------------------------------------
// <copyright file="ActivityBaseViewModel.cs" company="Nodine Legal, LLC">
...
namespace OpenLawOffice.Web.ViewModels.Activities
{
    ...
    [MapMe]
    public class ActivityBaseViewModel : CoreViewModel
    {
        public long? Id { get; set; }
        public ActivityTypeViewModel Type { get; set; }
        public bool IsCampaignResponse { get; set; }
        public string Subject { get; set; }
        public string Body { get; set; }
        public Contacts.ContactViewModel Owner { get; set; }
        public ActivityPriorityViewModel Priority { get; set; }
        public DateTime? Due { get; set; }
        public bool State { get; set; }
        public ActivityStatusReasonViewModel StatusReason { get; set; }
        public int? Duration { get; set; }
        // Regarding
        public ActivityRegardingLeadViewModel RegardingLead { get; set; }
        public ActivityRegardingOpportunityViewModel RegardingOpportunity { get; set; }

        public void BuildMappings()
        {
            Mapper.CreateMap<Common.Models.Activities.ActivityBase, ActivityBaseViewModel>()
            ...
            Mapper.CreateMap<ActivityBaseViewModel, Common.Models.Activities.ActivityBase>()
                .ForMember(dst => dst.Created, opt => opt.MapFrom(src => src.Created))
                .ForMember(dst => dst.Modified, opt => opt.MapFrom(src => src.Modified))
                .ForMember(dst => dst.Disabled, opt => opt.MapFrom(src => src.Disabled))
